...
Type: string. Required. Default value: '$(Build.ArtifactStagingDirectory)'.<br>
...
Input alias: `ArtifactType`. Type: string. Required. Allowed values: 'Container', 'FilePath'. Default value: 'Container'.<br>
<!-- :::editable-content name="helpMarkDown"::: -->
...
**`publishLocation`** - **Artifact publish location**<br>
Input alias: `ArtifactType`. Type: string. Required. Allowed values: 'Container', 'FilePath'.<br>
<!-- :::editable-content name="helpMarkDown"::: -->
Choose whether to store the artifact in Azure Pipelines (Container), or to copy it to a file share (FilePath) that must be accessible from the build agent. For more information, see [Artifacts in Azure Pipelines](/azure/devops/pipelines/artifacts/build-artifacts).
<!-- :::editable-content-end::: -->
...
Type: string. Optional. Use when ArtifactType = FilePath.<br>
<!-- :::editable-content name="helpMarkDown"::: -->
