...
`string`.<br>
<!-- :::editable-content name="helpMarkDown"::: -->
Optional. Add email addresses separated by semicolons (;) if you want to include additional email notification recipients (whether or not you checked the "subscription owners..." box).
<!-- :::editable-content-end::: -->
<br>
