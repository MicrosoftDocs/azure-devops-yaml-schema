...
1. Configure the .Net core sdk task that is used before the Publish Code Coverage Results v2 task using th following settings:
...
1. After the build completes and the Publish Code Coverage Results v2 task succeeds, select the **Code Coverage** tab in the pipeline run summary.
