...
`string`. Required.<br>
<!-- :::editable-content name="helpMarkDown"::: -->
Specifies the path to the application package. [Variables](http://learn.microsoft.com/azure/devops/pipelines/build/variables) and wildcards can be used in the path. `applicationPackagePath` must not have a trailing slash, either `\` or `/`.
<!-- :::editable-content-end::: -->
<br>
