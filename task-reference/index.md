...
| **Advanced Security Publish Results**<br>[AdvancedSecurity-Publish@1](advanced-security-publish-v1.md) | Enhances the data in the SARIF results file and publishes the results to the Advanced Security service. |
