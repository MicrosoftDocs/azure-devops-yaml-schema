...
On Windows agents, the agent uses the following PowerShell scripts to scan for tools and software and register the corresponding capabilities. These scripts are part of the [agent open source software](https://github.com/microsoft/azure-pipelines-agent) and are located in the [/src/Misc/layoutbin/powershell](https://github.com/microsoft/azure-pipelines-agent/tree/master/src/Misc/layoutbin/powershell) folder.
