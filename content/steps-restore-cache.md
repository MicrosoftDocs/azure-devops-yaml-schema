...
<!-- :::api-definition signature="step{restoreCache,path}" version="azure-pipelines-2019"::: -->
...
string
<!-- :::api-property-type-end::: -->  
<!-- :::api-desc type="property"::: -->Required. The folder path to download the cache to. This can be a fully-qualified path or a path relative to the root of the repository. Wildcards are not supported. 
 <!-- :::api-desc-end::: -->
  :::column-end:::
:::row-end:::
<!-- :::api-property-end::: -->
...
<!-- :::api-definition signature="step{restoreCache,path}" version="azure-pipelines-2019.1"::: -->
...
<!-- :::api-definition signature="step{restoreCache,path}" version="azure-pipelines-2020"::: -->
...
<!-- :::api-definition signature="step{restoreCache,path}" version="azure-pipelines-2020.1"::: -->
...
<!-- :::api-definition signature="step{restoreCache,path}" version="azure-pipelines-2022"::: -->
...
<!-- :::api-definition signature="step{restoreCache,path}" version="azure-pipelines"::: -->
...
The `restoreCache` keyword is a shortcut for the [Cache task](/azure/devops/pipelines/tasks/reference/cache-v2).
